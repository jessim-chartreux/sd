...
const Hours: React.FC<Props> = ({ onChange }) => {
	return (
		<div className="body">
			<header>
					...
					<div className="time">
						<div className="row">
							<div className="btn-time-container">
								<button className="btn-hour">19 h 00</button>
							</div>
							<div className="btn-time-container">
								<button className="btn-hour" onClick={() => onChange("time2")}>
									20 h 00
								</button>
							</div>
						</div>
						<div className="row">
							<div className="btn-time-container">
								<button className="btn-hour">21 h 00</button>
							</div>
							<div className="btn-time-container">
								<button className="btn-hour">22 h 00</button>
							</div>
						</div>
						<div className="row">
							<div className="btn-time-container">
								<button className="btn-hour">23 h 00</button>
							</div>
							<div className="btn-time-container">
								<button className="btn-hour">00 h 00</button>
							</div>
						</div>
						<div className="row">
							<div className="btn-time-container">
								<button className="btn-hour">01 h 00</button>
							</div>
							<div className="btn-time-container">
								<button className="btn-hour">02 h 00</button>
							</div>
						</div>
					</div>
				</div>

...
const Time: React.FC<Props> = ({ onChange }) => {
	return (
		<div className="body">
			<header>
					...
					<div className="time">
						<div className="time-col">
							<div className="btn-time-container">
								<button className="btn-time" onClick={() => onChange("hours")}>
									Heures. <i style={{ color: "#FFF" }} className="arrow-white down"></i>
								</button>
							</div>
							<div className="btn-time-container">

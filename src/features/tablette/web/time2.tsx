...
const Time2: React.FC<Props> = ({ onChange }) => {
	return (
		<div className="body">
			<header>
					...
					<div className="time">
						<div className="time-col">
							<div className="btn-time-container">
								<button className="btn-time-selected">
									20 h 00 <i style={{ color: "#FFF" }} className="arrow-green down"></i>
								</button>
							</div>
							<div className="btn-time-container">
								<button className="btn-time" onClick={() => onChange("mins")}>
									Minutes. <i style={{ color: "#FFF" }} className="arrow-white down"></i>
								</button>
							</div>
						</div>
					</div>

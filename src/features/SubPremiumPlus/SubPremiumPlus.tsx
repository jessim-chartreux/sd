		...
		<div style={{ width: "100%", height: "100%" }}>
			...
			<section className="SubPremiumPlus">
				<div className="header">
					...
					<div className="right">
						<h1>
							5000 <img src="https://cdn.sacul.cloud/v2/vision-cdn/icons/logo.webp" alt="logo" />
						</h1>
				...
				<div className="content">
					<div className="features">
						<div className="left">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.sacul.cloud/v2/vision-cdn/SubPremium/icons/casino-chip.webp"} alt="" />
								</div>
								<div className="content">
									<h3>Casino</h3>
